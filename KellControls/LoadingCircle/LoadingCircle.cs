...
namespace KellControls
{
    public partial class LoadingCircle : Control
    {
        ...
        private const int DefaultInnerCircleRadius = 42;
        private const int DefaultOuterCircleRadius = 43;
        private const int DefaultNumberOfSpoke = 12;
        private const int DefaultSpokeThickness = 14;
        private readonly Color DefaultColor = Color.DarkOrange;
        ...
        private bool m_IsTimerActive = true;
        ...
        private bool resizeWithContainer = true;
        ...
        /// <summary>
        /// 获取或设置环形载入图形是否跟随着控件的缩放也同时进行缩放
        /// </summary>
        [DefaultValue(true)]
        public bool ResizeWithContainer
        {
            get { return resizeWithContainer; }
            set { resizeWithContainer = value; }
        }
        ...
        protected override void OnResize(EventArgs e)
        {
            if (resizeWithContainer)
            {
                ...
                this.OuterCircleRadius = this.Width / 2 - this.SpokeThickness / 2;
                if (this.OuterCircleRadius < this.InnerCircleRadius + this.SpokeThickness / 2)
                {
                    int inR = this.OuterCircleRadius - this.SpokeThickness;
                    this.InnerCircleRadius = inR < 0 ? 0 : inR;
                }
            }
            base.OnResize(e);
        }
