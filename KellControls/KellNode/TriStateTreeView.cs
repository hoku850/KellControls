...
namespace KellControls
{
    ...
    {
        private int indexUnchecked = 3;
        private int indexIndeterminate = 4;
        private int indexChecked = 5;
        ...
        public int DirImageIndex
        {
            get
            {
                if (base.ImageList == null)
                    return -1;
                if (this._dirImageIndex >= this.ImageList.Images.Count)
        ...
        public int FileImageIndex
        {
            get
            {
                if (base.ImageList == null)
                    return -1;
                if (this._fileImageIndex >= this.ImageList.Images.Count)
                    return Math.Max(0, this.ImageList.Images.Count - 1);
        ...
        public int ExpandImageIndex
        {
            get
            {
                if (base.ImageList == null)
                    return -1;
                if (this._expandImageIndex >= this.ImageList.Images.Count)
                    return Math.Max(0, this.ImageList.Images.Count - 1);
        ...
        public int CollapseImageIndex
        {
            get
            {
                if (base.ImageList == null)
                    return -1;
                if (this._collapseImageIndex >= this.ImageList.Images.Count)
                    return Math.Max(0, this.ImageList.Images.Count - 1);
        ...
        public List<TriStateTreeNode> GetAllCheckedNodes()
        {
            return KellControls.Node.Generic<TriStateTreeNode>.GetAllCheckedNodes(this);
        }
            ...
            : base()
        {
            ...
            this.ImageList.Images.Add(KellControls.Properties.Resources.CollapsedFolderTreeItem16);
            this.ImageList.Images.Add(KellControls.Properties.Resources.FeedTreeItem16);
            this.ImageList.Images.Add(KellControls.Properties.Resources.ExpandedFolderTreeItem16);
            this.ImageList.Images.Add(KellControls.Properties.Resources.Unchecked);
            this.ImageList.Images.Add(KellControls.Properties.Resources.Indeterminate);
            this.ImageList.Images.Add(KellControls.Properties.Resources.Checked);
        }
                            ...
                            if (obj is NMTVCUSTOMDRAW)
                            {
                                ...
                                switch (tNMTVCUSTOMDRAW.nmcd.dwDrawStage)
                                {
                                    ...
                                    case CDDS_ITEMPOSTPAINT:
                                        node = System.Windows.Forms.TreeNode.FromHandle(this, tNMTVCUSTOMDRAW.nmcd.dwItemSpec);
