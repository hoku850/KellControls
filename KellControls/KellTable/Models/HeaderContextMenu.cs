	...
	public class HeaderContextMenu : ContextMenu
	{
		...
		internal class ShowColumnsDialog : Form
		{
			...
			public ShowColumnsDialog()
			{
				...
				this.columnTable.ColumnModel.Columns.Add(new CheckBoxColumn("Columns", 227, typeof(bool)));
			...
			public void AddColumns(ColumnModel model)
			{
				...
				this.columnTable.SelectionChanged += new KellControls.KellTable.Events.SelectionEventHandler(columnTable_SelectionChanged);
				this.columnTable.CellCheckChanged += new KellControls.KellTable.Events.CellCheckBoxEventHandler(columnTable_CellCheckChanged);
