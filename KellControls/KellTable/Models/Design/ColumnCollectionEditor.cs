...
namespace KellControls.KellTable.Models.Design
{
	...
	public class ColumnCollectionEditor : HelpfulCollectionEditor
	{
		...
		public ColumnCollectionEditor(Type type) : base(type)
		{
			...
			this.previewColumnModel.Columns.Add(new TextColumn("Column", 116, typeof(string)));
		...
		protected override object CreateInstance(Type itemType)
		{
			...
			column.PropertyChanged += new KellControls.KellTable.Events.ColumnEventHandler(column_PropertyChanged);
