...
namespace KellControls.KellTable.Models
{
	...
	public abstract class Column : Component
	{
        ...
        /// <summary>
        /// The Type of the Column' DataType
        /// </summary>
		...
		public Column(Type dataType) : base()
		{
			this.Init();
        ...
        /// <param name="dataType"></param>
        public Column(string text, Type dataType)
            : base()
		{
			this.Init();
            this.dataType = dataType;
        ...
        /// <param name="dataType"></param>
        public Column(string text, int width, Type dataType)
            : base()
		{
			this.Init();
            this.dataType = dataType;
        ...
        /// <param name="dataType"></param>
        public Column(string text, int width, bool visible, Type dataType)
            : base()
		{
			this.Init();
            this.dataType = dataType;
        ...
        /// <param name="dataType"></param>
        public Column(string text, Image image, Type dataType)
            : base()
		{
			this.Init();
            this.dataType = dataType;
		...
		/// <param name="width">The column's width</param>
        /// <param name="dataType"></param>
        public Column(string text, Image image, int width, Type dataType)
            : base()
		{
            this.Init();
            this.dataType = dataType;
		...
		/// <param name="visible">Specifies whether the column is visible</param>
        /// <param name="dataType"></param>
		public Column(string text, Image image, int width, bool visible, Type dataType) : base()
		{
			this.Init();
            this.dataType = dataType;
			this.text = text;
        ...
        /// <summary>
        /// Gets or sets the type of the column's data
        /// </summary>
        [Category("Appearance"),
        DefaultValue(""),
        Description("A type of the column's data.")]
