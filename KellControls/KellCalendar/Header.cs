...
namespace KellControls
{
	...
	public class Header : IDisposable
	{
        ...
        {
            Assembly ass = Assembly.LoadFrom(Application.StartupPath + "\\Resources.dll");
            Stream myStream = ass.GetManifestResourceStream("KellControls.Resources.Resources.Images." + name);
