...
namespace KellControls
{
	...
	[ToolboxItem(true)]
	[ToolboxBitmap(typeof(KellCalendar),"KellControls.MonthCalendar.bmp")]
	public class KellCalendar : System.Windows.Forms.Control
	{
        ...
        public class KeyboardConfig
        {
            ...
            public KeyboardConfig(KellCalendar calendar)
            {
                m_up = Keys.Up;
                m_parent = calendar;
                m_down = Keys.Down;
	...
	public class ActiveMonth
	{
		private int m_month;
		private int m_year;
		private KellCalendar m_calendar;
		...
		public ActiveMonth(KellCalendar calendar)
		{
			m_calendar = calendar;
	...
	internal class FirstDayOfWeekConverter : StringConverter
	{
		...
		public override object ConvertFrom(ITypeDescriptorContext context, CultureInfo culture, object value)
		{
			...
			if (value.GetType() == typeof(string))
			{
				KellCalendar m = (KellCalendar)context.Instance;
	...
	internal class DateTimeTypeConverter : ExpandableObjectConverter
	{
		...
		public override object ConvertTo(ITypeDescriptorContext context, CultureInfo culture, object value, Type destinationType)
		{
			if(destinationType == typeof(string))
			{
				KellCalendar cal = (KellCalendar)context.Instance; 
    ...
    public class CalendarActionList : System.ComponentModel.Design.DesignerActionList
    {
        ...
        public CalendarActionList(IComponent component)
            : base(component)
        {
            this.calendar = component as KellCalendar;
